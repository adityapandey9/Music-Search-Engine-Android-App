...
public class HistoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.card_recycler_views);
        textView = (TextView) view.findViewById(R.id.nodata);
        ArrayList<SongList> data = new ArrayList<>(SongList.find(SongList.class, "DOWN = ?", "1"));
//        Toast.makeText(getContext(), "Size-H: "+data.size(), Toast.LENGTH_SHORT).show();
        if(data.size() > 0) {
